...
```{r}
# I choose to use the "here" function because I initialized this repo to work with Github.  If people were to fork my repo, they could run this code because the "here" puts everything in terms of their relative file path
polls <- read_csv(here("data", "rcp-polls.csv"))

# without the "here" function: read_csv("data/rcp-polls.csv")
